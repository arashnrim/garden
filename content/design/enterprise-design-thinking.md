...
- hills — aligning the team around meaningful user outcomes you want to achieve, where statements of intent are written as user enablements (follows a format of who, what, and wow);
