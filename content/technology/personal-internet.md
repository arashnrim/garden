...
I came across an event from the National Library Board about [crafting a handmade web](https://nlb.libcal.com/event/5858205) and signed up for it. In preparation for that chat, I decided to go down a rabbit hole behind [one of the speakers' Are.na pages](https://www.are.na/lina-l/websites-im-perceiving) — and as I dive deeper, the clearer the idea of a personal internet spoke out to me.

I'm particularly drawn to one of the websites in her collection: [A Website is a Room](https://a-website-is-a-room.net/). It acts as a directory that points to other sites that contains some quality of "slowness, quiet, and/or gathering". **So is a personal internet one that contains *soul*?**
...
# Discussions from Beyond Text: Crafting a Handmade Web

> [!question] Pre-event questions
> 
> - How do you think [[generative-ai|gen AI]] plays a role in crafting a handmade web? Does it seek to collaborate or replace?
...
- [Perfectly Imperfect](https://pi.fyi)
- [Are.na](https://are.na)
...
- Digital gardens: people are uploading notes onto websites ([[index|heeeeey]]) — Zettelkasten system to craft a web of knowledge
...
- Pulling (based on interest, e.g. [[digital-gardening|digital gardens]]) vs pushing (against your will, e.g. ads); agency with how you interact with the internet
...
- Aesthetic of the "hand-made web": nostalgic '90s vibe; how can you tell if someone is just borrowing the old tech aesthetic vs actually living the ethos of crafting the hand-made web?
	...
	- Rafi brought up [CARI](https://cari.institute/)
...
- Is [Wikipedia](https://en.wikipedia.org) an example of a successful hand-made web?
